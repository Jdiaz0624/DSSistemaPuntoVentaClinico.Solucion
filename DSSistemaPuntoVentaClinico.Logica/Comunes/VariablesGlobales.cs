...
namespace DSSistemaPuntoVentaClinico.Logica.Comunes
{
    public class VariablesGlobales
    {
        ...
        public decimal IDComisionPagar { get; set; }
        public decimal IdProgramacionCirugiaPagar { get; set; }
        ...
        public string TruquitoCamara = "NO";
        public long NumeroConvertir { get; set; }
