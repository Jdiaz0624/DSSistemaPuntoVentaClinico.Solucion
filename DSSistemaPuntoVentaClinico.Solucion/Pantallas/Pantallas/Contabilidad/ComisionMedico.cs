    ...
    public partial class ComisionMedico : Form
    {
        ...
        private void GenerarReciboPagoComision(decimal IdComision)
        {
            try {
                ...
                DSSistemaPuntoVentaClinico.Solucion.Pantallas.Pantallas.Reporte.Reporte Recibo = new Reporte.Reporte();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (DatoLetrero == "Comisión Detalle")
            {
                ...
                //INVOCAMOS EL REPORTE
                DSSistemaPuntoVentaClinico.Solucion.Pantallas.Pantallas.Reporte.Reporte Reporte = new Reporte.Reporte();
            ...
            else
            {
                ...
                DSSistemaPuntoVentaClinico.Solucion.Pantallas.Pantallas.Reporte.Reporte ReporteUnico = new Reporte.Reporte();
